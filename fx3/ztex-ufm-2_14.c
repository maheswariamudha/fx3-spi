...
%*/
/* 
   Board specific functions for ZTEX-USB FPGA Module 2.14
*/

#ifndef _ZTEX_CONF_UFM_2_14_C1_
#define _ZTEX_CONF_UFM_2_14_C1_

#include "cyu3pib.h"

// product ID's for ZTEX USB-FPGA Module 2.14 are 10.41.*.*
#undef ZTEX_PRODUCT_ID_0
#define ZTEX_PRODUCT_ID_0	(10)
#undef ZTEX_PRODUCT_ID_1
#define ZTEX_PRODUCT_ID_1	(41)

/* 
   This macro defines the Product string. Limited to 31 characters. 
*/
#undef ZTEX_PRODUCT_STRING
#define ZTEX_PRODUCT_STRING "ZTEX USB-FPGA Module 2.14"
...
#endif // _ZTEX_CONF_UFM_2_14_C1_

CyU3PPibClock_t pibclock;

#ifdef _ZTEX_INCLUDE_2_
#ifndef _ZTEX_CONF_UFM_2_14_C2_
#define _ZTEX_CONF_UFM_2_14_C2_
...
void ztex_fpga_config_start(CyU3PDmaSocketId_t socket) {
	ZTEX_LOG("ztex_fpga_config_start : %s",socket);
...
void ztex_board_init() {
    ...
    ztex_log ( "Info: Initializing USB-FPGA Module 2.14" );
    ...
    ztex_pib_clock2 = ZTEX_FPGA_CONFIGURED ? &pibclock : &ztex_fpgaconf1_pib_clock;
}    
